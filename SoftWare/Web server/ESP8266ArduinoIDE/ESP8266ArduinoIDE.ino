...
/*trandanhlam@gmail.com*/
/*researchgate.net/profile/Lam_Tran29*/
...
void loop(){
  ...
  if (client) {                             // If a new client connects,
    //Serial.println(" NC");                // print a message out in the serial port
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".button3 { background-color: #f70e0a; border: none; color: white; padding: 20px;");
            ...
            else if(Tvoltage>3 && Tvoltage<=4.3){
            ...
            //--------------------------reset---------------------
            client.println("<p><a href=\"/1/on\"><button class=\"button button3\">RESET</button></a></p>");
            //----------------------pin 2 den-------------------- 
            ...
            //client.println("<ul><li><p>Speed: <INPUT type='number' name='speed' id='speed' value='%s, &Speed' min='0' max='5000'>");
            
            client.println("<p>Speed: <input type=\"number\" name=\"txt\" value=\"" + 
            String(EEPROM.read(0)) + "\" onchange=\"setSpeed(this.value)\" min=\"0\" max=\"5000\"></p>");
            ...
            client.print("<INPUT type='submit' value='Submit'></li></ul>");
