...
#define ssid      "VIETTEL_CHUYEN"       // WiFi SSID
#define password  "0903482723"        // WiFi password
...
float RatioFactor=0.85 ;  //Resistors Ration Factor
int value = LOW;
float Tvoltage=0.0;
...
String getPage(){
  ...
  page += "<p>Speed: <INPUT type='number' name='speed' id='speed' value='' min='50' max='5000'>";
